...
- [ ] 7. AI 位图替换：`docs/*/imgs/prompts/` 提示词已备好，等出图通道可用时把 SVG 换成 PNG（2026-08-05 再测：出图通道仍返回 `channel:no_available_key`，保持待办）
- [~] 8. 持续补充日志与案例：按 writing-prompt 模板扩展系列（已完成第 2 篇《Rust WASM 前端集成实录》，可持续用 /vibe-log 扩展）
