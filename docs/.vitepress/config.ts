      ...
      '/notes/': [
        {
          ...
          items: [
            { text: '索引', link: '/notes/' },
            { text: 'Monorepo 是什么', link: '/notes/monorepo' },
            { text: 'pnpm workspace', link: '/notes/pnpm-workspace' },
            { text: 'Nuxt vs Vite SPA', link: '/notes/nuxt-vs-vite-spa' },
            { text: '共享包 Shared Packages', link: '/notes/shared-packages' },
          ],
        },
      ],
      '/examples/': [
